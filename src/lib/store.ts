...
interface AppState {
  currentView: 'dashboard' | 'agents' | 'automation' | 'guardrails' | 'coordination' | 'settings' | 'approvals' | 'analytics' | 'media' | 'voice' | 'scheduler' | 'billing' | 'marketplace' | 'collaboration' | 'avatars' | 'browser' | 'multimodal';
