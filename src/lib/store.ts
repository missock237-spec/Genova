...
interface AppState {
  currentView: 'dashboard' | 'agents' | 'automation' | 'guardrails' | 'coordination' | 'settings' | 'approvals' | 'analytics' | 'media' | 'voice' | 'scheduler' | 'marketplace' | 'collaboration' | 'avatars' | 'browser' | 'multimodal' | 'integrations';
