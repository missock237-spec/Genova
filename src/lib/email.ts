...
export async function sendVerificationEmail(
  ...
  return sendEmail(to, 'Vérifiez votre adresse email — Genova', `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 32px;">
        <h1 style="color: #f5f5f5; font-size: 24px; font-weight: 700;">Genova</h1>
      </div>
      <div style="background: #1a1a2e; border-radius: 12px; padding: 32px; border: 1px solid #2a2a4a;">
        ...
        <p style="color: #808090; font-size: 13px;">Si vous n'avez pas créé de compte Genova, veuillez ignorer cet email.</p>
      </div>
      <p style="text-align: center; color: #606070; font-size: 12px; margin-top: 24px;">
        Genova — AI Operating System
      </p>
    </div>
  `, {
...
export async function sendPasswordResetEmail(
  ...
  return sendEmail(to, 'Code de réinitialisation — Genova', `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 32px;">
        <h1 style="color: #f5f5f5; font-size: 24px; font-weight: 700;">Genova</h1>
      </div>
...
export async function sendWelcomeEmail(
  ...
  return sendEmail(to, 'Bienvenue sur Genova !', `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 32px;">
        <h1 style="color: #f5f5f5; font-size: 24px; font-weight: 700;">Genova</h1>
      </div>
      <div style="background: #1a1a2e; border-radius: 12px; padding: 32px; border: 1px solid #2a2a4a;">
        ...
        <p style="color: #a0a0b0; font-size: 15px;">
          Votre compte Genova a été créé avec succès. Vous pouvez maintenant :
        </p>
